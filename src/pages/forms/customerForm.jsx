...
const CustomerLogin = () => {
  ...
  const handleSubmit = async(e) => {
      ...
      try{
           const response =await  axios.post("https://bsic-api-production-6fde.up.railway.app/api/customers/accounts/login",formData,{headers:{"Content-Type":"application/json"}})
