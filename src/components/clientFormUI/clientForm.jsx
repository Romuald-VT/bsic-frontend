...
const ClientForm =({setModal})=>{
    ...
    const handleSubmit = async(e)=>{
        ...
        try {
            ...
            const response = await axios.post('https://bsic-api-production-6fde.up.railway.app/api/customers/accounts/add',formDataToSend,{headers:{"Content-Type":"application/json",Authorization:token}})
