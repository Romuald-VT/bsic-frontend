...
const AmountDialog = ({number,showModal,email})=>{
    ...
    const handleSubmit = async()=>{
        ...
        formData.append('amount',amount)
         try{
            const response  = await axios.post(`https://bsic-api-production-6fde.up.railway.app/api/customers/info/${email}`,formData,{headers:{"Content-Type":'application/json',Authorization:token}})
